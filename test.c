...
int main(void) {
    ...
    passed +=
        test_function_cb(C_ARR_LEN_arg_ptr_test, "C_ARR_LEN_arg_ptr_test");
    ...
    passed +=
        test_function_cb(BUF_FROM_C_ARR_NULL_test, "BUF_FROM_C_ARR_NULL_test");
    passed += test_function_cb(_BUF_ASSERT_ptr_is_NULL_test,
                               "_BUF_ASSERT_ptr_is_NULL_test");
    passed += test_function_cb(_BUF_ASSERT_undeflow_test,
                               "_BUF_ASSERT_undeflow_test");
    passed += test_function_cb(_BUF_ASSERT_overflow_test,
                               "_BUF_ASSERT_overflow_test");
