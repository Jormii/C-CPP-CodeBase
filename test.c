...
extern i32 BUF_ptr_const_test(void);
extern i32 BUF_ptr_const_ptr_is_NULL_test(void);
extern i32 BUF_ptr_const_undeflow_test(void);
extern i32 BUF_ptr_const_overflow_test(void);
extern i32 BUF_ptr_const_out_ptr_is_NULL_test(void);
...
extern i32 BUF_CONST_ptr_const_test(void);
extern i32 BUF_CONST_ptr_const_ptr_is_NULL_test(void);
extern i32 BUF_CONST_ptr_const_undeflow_test(void);
extern i32 BUF_CONST_ptr_const_overflow_test(void);
extern i32 BUF_CONST_ptr_const_out_ptr_is_NULL_test(void);
...
int main(void) {
	...
	passed += test_function_cb(BUF_ptr_const_test, "BUF_ptr_const_test");
	passed += test_function_cb(BUF_ptr_const_ptr_is_NULL_test, "BUF_ptr_const_ptr_is_NULL_test");
	passed += test_function_cb(BUF_ptr_const_undeflow_test, "BUF_ptr_const_undeflow_test");
	passed += test_function_cb(BUF_ptr_const_overflow_test, "BUF_ptr_const_overflow_test");
	passed += test_function_cb(BUF_ptr_const_out_ptr_is_NULL_test, "BUF_ptr_const_out_ptr_is_NULL_test");
	...
	passed += test_function_cb(BUF_CONST_ptr_const_test, "BUF_CONST_ptr_const_test");
	passed += test_function_cb(BUF_CONST_ptr_const_ptr_is_NULL_test, "BUF_CONST_ptr_const_ptr_is_NULL_test");
	passed += test_function_cb(BUF_CONST_ptr_const_undeflow_test, "BUF_CONST_ptr_const_undeflow_test");
	passed += test_function_cb(BUF_CONST_ptr_const_overflow_test, "BUF_CONST_ptr_const_overflow_test");
	passed += test_function_cb(BUF_CONST_ptr_const_out_ptr_is_NULL_test, "BUF_CONST_ptr_const_out_ptr_is_NULL_test");
