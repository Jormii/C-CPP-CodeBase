...
extern i32 RES_C_get_test(void);
extern i32 BUF_ptr_test(void);
extern i32 BUF_ptrc_test(void);
extern i32 BUF_C_ptrc_test(void);
...
int main(void) {
	...
	passed += test_function_cb(RES_C_get_test, "RES_C_get_test");
	passed += test_function_cb(BUF_ptr_test, "BUF_ptr_test");
	passed += test_function_cb(BUF_ptrc_test, "BUF_ptrc_test");
	passed += test_function_cb(BUF_C_ptrc_test, "BUF_C_ptrc_test");
